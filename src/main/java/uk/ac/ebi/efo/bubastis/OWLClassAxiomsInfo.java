...
/*
 * Helper class to store information on a class which can be used to store information about
 * difference between two classes newClassAxiomsSet holds axioms that have been added to this class
 * and deletedClassAxiomsSet holds axioms that have been removed compared with the same class in
 * another ontology
 */
...
public class OWLClassAxiomsInfo implements Serializable {
  ...
  // constructor
  public OWLClassAxiomsInfo(IRI classIRI, Set<OWLAnnotation> classLabels,
      Set<OWLClassAxiom> newClassAxiomsSet, Set<OWLClassAxiom> deletedClassAxiomsSet) {
    this.classIRI = classIRI;
  ...
  /**
   * method for returning the rdfs labels of a class as Set of strings rather than OWLAnnotion
   * objects
   * 
  ...
  public Set<String> getDeletedAnnotations() {
    return getFullAnnotationsAsStrings(deletedAnnotationsSet);
  }

  // get method to return the deleted annotations
  public Set<String> getNewAnnotations() {
    return getFullAnnotationsAsStrings(newAnnotationsSet);
  }
  ...
  /**
   * method for returning a set of String objects from a given set of OWLAnnotation objects useful
   * in particular for displaying purposes
   * 
  ...
  public Set<String> getFullAnnotationsAsStrings(Set<OWLAnnotation> classAnnotations) {
    ...
    if (classAxioms == null) {
      ...
      while (it.hasNext()) {
        ...
        while (it2.hasNext()) {
          ...
          Set<OWLAnnotation> entityLabels =
              new HashSet<>(EntitySearcher.getAnnotations(e, ontology, label));
  ...
  public class SimpleLabelProvider implements ShortFormProvider {
    ...
    public String getShortForm(OWLEntity entity) {
      ...
      Set<OWLAnnotation> entityLabels =
          new HashSet<>(EntitySearcher.getAnnotations(entity, ontology, label));
