...
/**
 * Created with IntelliJ IDEA. User: local_admin Date: 19/11/13 Time: 14:19 To change this template
...
class Driver {
  ...
  public static void main(String[] args) {
    ...
    GFBioConfiguration configuration = new GFBioConfiguration();
    ...
    try {
      ...
      // do diff
      CompareOntologies comparer = new CompareOntologies(labelIRI, synIRI);
